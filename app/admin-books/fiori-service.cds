...
annotate sap.capire.bookshop.Substancies with @fiori.draft.enabled;
annotate AdminService.Substancies with @odata.draft.enabled;
annotate AdminService.ItemGroups_draft with @odata.draft.enabled;
// annotate AdminService.AdminService_Substancies_drafts with @cds.persistence.exists;
